/*package com.howtodoinjava.config.datasource.postgres.order;
...
@EnableJpaRepositories(entityManagerFactoryRef = "orderEntityManagerFactory", transactionManagerRef = "orderTransactionManager", basePackages = {
		"com.howtodoinjava.repositories.order" })
public class OrderDatasourceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.howtodoinjava.model.order").persistenceUnit("order")
				.build();
	}
