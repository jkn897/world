package com.howtodoinjava.config.datasource.h2.user;
...
@EnableJpaRepositories(entityManagerFactoryRef = "userEntityManagerFactory", transactionManagerRef = "userTransactionManager", basePackages = {
		"com.howtodoinjava.repositories.user" })
public class UserDatasourceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.howtodoinjava.model.user").persistenceUnit("users").build();
	}
